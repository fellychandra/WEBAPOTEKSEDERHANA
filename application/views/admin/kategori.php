                          ...
                          <table class="table table-striped" id="table1">
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td>
                                        <a href="<?php echo base_url('welcome/formeditkategori/').$k->id_kategori?>"><button class="btn btn-primary">Edit</button></a>
                                        <a href="<?php echo base_url('welcome/aksihapuskategori/').$k->id_kategori?>" onclick="return confirm('Yakin Hapus?')"><button class="btn btn-danger">Hapus</button></a>
                                    </td>
                                </tr>
                            <?php  
                              } 
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form method="POST" action="<?php echo base_url('welcome/aksiinsertkategori')?>">
...
//   <!-- jquery untuk edit kategori -->
    ...
    $(document).ready(function(e) {
        $("#form_kategori").on("submit", (function (e) {
            e.preventDefault();
            $.ajax({
              url : '<?php echo base_url('welcome/aksiedit')?>',
              type : 'POST',
