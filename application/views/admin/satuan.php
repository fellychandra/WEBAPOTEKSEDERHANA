                  ...
                  <table class="table table-striped" id="table1">
                    ...
                    ?>
                        ...
                        <td><?php echo $no++;?></td>
                            ...
                            <td>
                              <a href="<?php echo base_url('welcome/formeditsatuan/').$s->id_satuan?>"><button class="btn btn-primary">Edit</button></a>
                              <a href="<?php echo base_url('welcome/aksihapussatuan/').$s->id_satuan?>" onclick="return confirm('Yakin Hapus?')"><button class="btn btn-danger">Hapus</button></a>
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form method="POST" action="<?php echo base_url('welcome/aksiinsertsatuan')?>">
