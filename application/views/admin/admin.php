        ...
        <div class="row">
          <div class="col-md-12">
            ...
            <div class="card-header">
                <h4 class="card-title col-md-8">Data admin</h4>
                <nav class="navbar navbar-expand-lg navbar-absolute fixed-top navbar-transparent">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                  ...
                                  <a href="<?php echo base_url('welcome/formeditadmin/').$a->username?>"><button class="btn btn-primary">Edit</button></a>
                                  <a href="<?php echo base_url('welcome/aksihapusadmin/').$a->username?>" onclick="return confirm('Yakin Hapus?')"><button class="btn btn-danger" > Hapus</button></a>
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form method="POST" action="<?php echo base_url('welcome/aksiinsertadmin')?>">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="hidden" name="level" value="admin" class="form-control" required>                                
                                <div class="text-center">
                                    <button class="btn btn-primary" name="tambah_admin" type="submit" value="tambah">Tambah Admin</button>
                                </div>
                            </form>
                            <div class="text-center">
                                <p>Or</p>
                            ...
                            <div class="text-center">
                                    <a href="../view/login/google.php">
                                        <img src="../view/assets/templatesadmin/icon/sign.png" width="200px">
                                    </a>
                            </div>
                        </div>
                    </div>
