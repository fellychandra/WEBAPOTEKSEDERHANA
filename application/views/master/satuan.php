        ...
        <div class="row">
          <div class="col-md-12">
            ...
            <div class="card-header">
                <h4 class="card-title col-md-8">Satuan Obat</h4>
                <nav class="navbar navbar-expand-lg navbar-absolute fixed-top navbar-transparent">
                    <div class="collapse navbar-collapse justify-content-end" id="navigation">
                        <ul class="navbar-nav">
                            <li class="nav-item">
                                <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#tambah">Tambah Satuan Obat</button>
                            </li>
                        </ul>
                    </div>
                </nav>
              ...
              <div class="card-body">
                  <table class="table table-striped" id="table1">
                    ...
                    ?>
                        <tr>
                        <td><?php echo $no++;?></td>
                                <td><?php echo $s->satuan_obat?></td>

                            <td>
                              <a href="<?php echo base_url('C_master/formeditsatuan/').$s->id_satuan?>"><button class="btn btn-primary">Edit</button></a>
                              <a href="<?php echo base_url('C_master/aksihapussatuan/').$s->id_satuan?>" onclick="return confirm('Yakin Hapus?')"><button class="btn btn-danger">Hapus</button></a>
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form method="POST" action="<?php echo base_url('C_master/aksiinsertsatuan')?>">
                                <div class="form-group">
                                    <input type="text" placeholder="Satuan Obat" name="satuan_obat" class="form-control" required>
                                </div>
                                <div class="modal-footer">
                                    <button class="btn btn-primary" name="tambah" type="submit" value="tambah">Tambah Satuan</button>
                                </div>
                            </form>
                        </div>
                    </div>
