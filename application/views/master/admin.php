            ...
            <div class="card-header">
                ...
                <nav class="navbar navbar-expand-lg navbar-absolute fixed-top navbar-transparent">
                    <div class="collapse navbar-collapse justify-content-end" id="navigation">
                        <ul class="navbar-nav">
                            <li class="nav-item">
                                <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#tambah">Tambah Admin Obat</button>
                            </li>
                        </ul>
                    </div>
                </nav>
                      ...
                      <table class="table table-striped" id="table1">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                  <a href="<?php echo base_url('C_master/formeditadmin/').$a->username?>"><button class="btn btn-primary">Edit</button></a>
                                  <a href="<?php echo base_url('C_master/aksihapusadmin/').$a->username?>" onclick="return confirm('Yakin Hapus?')"><button class="btn btn-danger" > Hapus</button></a>
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form method="POST" action="<?php echo base_url('C_master/aksiinsertadmin')?>">
