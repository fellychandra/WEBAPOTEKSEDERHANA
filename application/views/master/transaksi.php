                                    ...
                                    ?>
                                        <tr>
                                          ...
                                          <td>
                                              ...
                                              <a href="<?php echo base_url('C_master/formedittransaksi/').$o->id_transaksi?>"><button class="btn btn-primary">Edit</button></a>
                                              <a href="<?php echo base_url('C_master/aksihaputtransaksi/').$o->id_transaksi?>" onclick="return confirm('Yakin Hapus?')" ><button class="btn btn-danger">Hapus</button></a>
                                          </td>
                                        </tr>
                                    <?php                                       
                                      } 
                  ...
                  <div class="modal-dialog" role="document">
                      <div class="modal-content">
                          ...
                          <div class="modal-body">
                              <form method="POST" action="<?php echo base_url('C_master/aksiinserttransaksi')?>">
                                  <input type="hidden" name="update_id" id="update_id">
                                  <input type="hidden" class="form-control" value="<?php echo $this->session->userdata("username"); ?>" name="username">
                                  <div class="form-group">
                                      <input type="date" placeholder="Tanggal" name="tanggal" id="nama_obat" class="form-control" required>
                                  </div>
                                  <div class="form-group">
