          ...
          <div class="col-md-12">
            <div class="card ">
                <div class="card-header">
                    <h4 class="card-title col-md-8">Kategori Obat</h4>
                    <nav class="navbar navbar-expand-lg navbar-absolute fixed-top navbar-transparent">
                      ...
                      <div class="card-body">
                          <table class="table table-striped" id="table1">
                            ...
                            ?>
                                <tr>
                                    <td><?php echo $no++;?></td>
                                    <td><?php echo $k->kategori_obat?></td>

                                    <td>
                                        <a href="<?php echo base_url('C_master/formeditkategori/').$k->id_kategori?>"><button class="btn btn-primary">Edit</button></a>
                                        <a href="<?php echo base_url('C_master/aksihapuskategori/').$k->id_kategori?>" onclick="return confirm('Yakin Hapus?')"><button class="btn btn-danger">Hapus</button></a>
                                    </td>
                                </tr>
                            <?php  
                              } 
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form method="POST" action="<?php echo base_url('C_master/aksiinsertkategori')?>">
                                    <div class="form-group">
                                        <input type="text" placeholder="Kategori Obat" name="kategori_obat" class="form-control" required>
                                    </div>
                                    <div class="modal-footer">
                                        <button class="btn btn-primary" type="submit" value="tambah">Tambah Kategori</button>
                                    </div>
                                </form>
                            </div>
                        </div>
...
//   <!-- jquery untuk edit kategori -->
    ...
    $(document).ready(function(e) {
        $("#form_kategori").on("submit", (function (e) {
            e.preventDefault();
            $.ajax({
              url : '<?php echo base_url('C_master/aksiedit')?>',
              type : 'POST',
